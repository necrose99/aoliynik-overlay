...
src_prepare() {
	...
	if use ubuntu; then
		...
		epatch "${FILESDIR}"/${PN}-ubuntu-05_add_hinting_and_antialiasing_confs.patch
		epatch "${FILESDIR}"/${PN}-ubuntu-05_lcdfilterlegacy.patch
		epatch "${FILESDIR}"/${PN}-ubuntu-06_lcddefault.patch
