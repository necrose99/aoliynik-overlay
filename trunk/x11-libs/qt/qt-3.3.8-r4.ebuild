...
src_unpack() {
	...
	if ! use qt-copy ; then
		...
		epatch ${FILESDIR}/0073-xinerama-aware-qpopup.patch
		epatch ${FILESDIR}/0078-argb-visual-hack.patch
		epatch ${FILESDIR}/0079-compositing-types.patch
		epatch ${FILESDIR}/0080-net-wm-sync-request.patch
		epatch ${FILESDIR}/0081-format-string-fixes.diff
		epatch ${FILESDIR}/0084-compositing-properties.patch
	fi
