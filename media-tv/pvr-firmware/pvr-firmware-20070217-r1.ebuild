...
src_unpack() {
	unpack ${A}
	cd "${S}"
	mv hauppauge_cd_3.4D1/Drivers/Driver18/hcw18apu.rom v4l-cx23418-apu.fw
	mv hauppauge_cd_3.4D1/Drivers/Driver18/hcw18enc.rom v4l-cx23418-cpu.fw
	mv hauppauge_cd_3.4D1/Drivers/Driver18/hcw18mlC.rom v4l-cx23418-dig.fw
}
